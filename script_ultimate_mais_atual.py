...
def calculate_botao():
        ...
        funcao = fxentry.get()
        eps = int(epsentry.get())
        in1 = int(interentry.get())
...
def calculate_botao_newton():
        ...
        funcao = fxentry.get()
        eps = int(epsentryNewton.get())
        x0 = int(interentryNewton.get())
        in2 = float(interentry1Newton.get())
        result = newton(funcao,x0,tol = 0.001, maxIter = 5)
        resultadoNewton.delete(0,'end')
        resultadoNewton.insert(0,result)    
